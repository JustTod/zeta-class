...
describe('FizzBuzz', () => {
  ...
  it.each`
    ...
    ${42}
  `(
    `should be FizzBang when it is multiply by 3 and 7 ($input)`,
    ({ input }: { input: number }) => {
      // Act
      const actual = fizzBuzz(input);

      // Assert
      expect(actual).toBe('FizzBang');
  });
  ...
  it.each`
    ...
    ${70}
  `(
    `should be BuzzBang when it is multiply by 5 and 7 ($input)`,
    ({ input }: { input: number }) => {
      // Act
      const actual = fizzBuzz(input);

      // Assert
      expect(actual).toBe('BuzzBang');
  });
  ...
  it.each`
    ...
    ${105}
  `(
    `should be FizzBuzzBang when it is multiply by 3, 5 and 7 ($input)`,
    ({ input }: { input: number }) => {
      // Act
      const actual = fizzBuzz(input);

      // Assert
      expect(actual).toBe('FizzBuzzBang');
    });
});
